  ...
  <div class="main-layout">
    ...
    <div class="drawer" class:drawer-open={drawerOpen}>
      ...
      <div class="drawer-content">
        ...
        <button id="statistics" class="btn btn-outline nav-button" class:highlight={route === 'statistics'} on:click={() => replace('/statistics')}>Statistics</button>       
        <button id="teams" class="btn btn-outline nav-button" class:highlight={route === 'teams'} on:click={() => replace('/teams')}>Teams</button>        
        <button id="bets" class="btn btn-outline nav-button" class:highlight={route === 'bets'} on:click={() => replace('/bets')}>Bets</button>  
